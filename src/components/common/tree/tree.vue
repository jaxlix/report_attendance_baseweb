    ...
    <div id="tree">
        <div class="tree-content">
            <div class="tree-tree">
                ...
                <div class="search" v-show="searchData.length>0">
                ...
                <div class="treeBox" v-show="searchData.length==0">
                    <el-tree
                        node-key="id"
                        ref="zTree"
                        lazy
...
export default {
    ...
    methods: {
        ...
        checkChange() {
            let arr = [];
            this.$refs.zTree.getCheckedNodes().forEach(d => {
                if (d.leaf) {
                    arr.push(d);
                }
            });
            ...
            this.checked = this.checkedPc.concat(this.checkedPhone);
        },
        // 确定提交
        commit() {
            let data = []
            this.checked.forEach( d => {
                ...
                if(d.members.length > 0){
                    for (let index = 0; index < d.members.length; index++) {
                        const element = d.members[index];
                        if(element.type == this.nav || element.terminalMemberType == this.nav){
